...
from factories import logger_factory
...
def copper_lead_scraper(state, url, date_ranges, filetype):
    ...
    logger = logger_factory.build_logger(state, log_location, 'copper_lead')
...
def chem_scraper(state, url, date_ranges, filetype):
    ...
    logger = logger_factory.build_logger(state, log_location, 'chem')
    chem_scrape = 'CHEM'
...
def coli_scraper(state, url, date_ranges, filetype):
    ...
    logger = logger_factory.build_logger(state, log_location, 'coli')
